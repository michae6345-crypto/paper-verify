...
- `checks/row_arithmetic.py:546–561`, the same, inside `_judge_table()`
...
Q5 pointed at the checkers; the duplication is upstream. The checkers are clean, and
...
The corollary is uncomfortable: the file-ownership discipline that made parallel agents
safe is also what produced this. Agents A and B were correctly
